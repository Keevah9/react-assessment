  ...
  return (
    <Link href={url}>
      <div className="max-w-3xl mx-4 mx-auto mt-5">
        <motion.div
          className="rounded-[15px] pb-5 relative border border-white/15 overflow-hidden min-h-auto lg:col-span-1 col-span-full"
        ...
        >
          <div className="rounded-[15px] relative overflow-hidden flex flex-col justify-between items-center">
            ...
            <div className="gap-y-2 flex flex-col items-center text-center relative z-10 px-4 pb-5">
